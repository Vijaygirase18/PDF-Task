...
function PDFGeneratorForm() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const feeStructure = getFeeStructure(formData.course);
        generatePDF(formData.name, formData.course, feeStructure);
    };
    ...
    const getFeeStructure = (course) => {
        const feeStructures = {
            "Engineering (B.Tech, B.E.)": [
                ...
                { year: "2nd Year", oneTimeFee: 62000, tuitionFee: 21000 },
                { year: "3rd Year", oneTimeFee: 64000, tuitionFee: 22000 }
            ],
            "Medicine (MBBS)": [
                { year: "1st Year", oneTimeFee: 100000, tuitionFee: 30000 },
                { year: "2nd Year", oneTimeFee: 110000, tuitionFee: 32000 },
                { year: "3rd Year", oneTimeFee: 120000, tuitionFee: 34000 }
            ],
            "Dentistry (BDS)": [
                { year: "1st Year", oneTimeFee: 80000, tuitionFee: 25000 },
                { year: "2nd Year", oneTimeFee: 82000, tuitionFee: 26000 },
                { year: "3rd Year", oneTimeFee: 84000, tuitionFee: 27000 }
            ],
            "Nursing (B.Sc Nursing)": [
                { year: "1st Year", oneTimeFee: 50000, tuitionFee: 18000 },
                { year: "2nd Year", oneTimeFee: 52000, tuitionFee: 19000 },
                { year: "3rd Year", oneTimeFee: 54000, tuitionFee: 20000 }
            ],
            "Pharmacy (B.Pharm)": [
                { year: "1st Year", oneTimeFee: 70000, tuitionFee: 23000 },
                { year: "2nd Year", oneTimeFee: 72000, tuitionFee: 24000 },
                { year: "3rd Year", oneTimeFee: 74000, tuitionFee: 25000 }
            ],
            "Law (LLB)": [
                { year: "1st Year", oneTimeFee: 60000, tuitionFee: 20000 },
                { year: "2nd Year", oneTimeFee: 62000, tuitionFee: 21000 },
            ...
            "Business Administration (BBA)": [
                ...
                { year: "2nd Year", oneTimeFee: 42000, tuitionFee: 16000 },
                { year: "3rd Year", oneTimeFee: 44000, tuitionFee: 17000 }
            ],
            ...
            "Education (B.Ed)": [
                ...
                { year: "2nd Year", oneTimeFee: 32000, tuitionFee: 13000 },
                { year: "3rd Year", oneTimeFee: 34000, tuitionFee: 14000 }
            ],
            "Architecture (B.Arch)": [
                { year: "1st Year", oneTimeFee: 70000, tuitionFee: 23000 },
                { year: "2nd Year", oneTimeFee: 72000, tuitionFee: 24000 },
            ...
            "Mechanical Engineering (B.Tech/B.E., M.Tech)": [
                ...
                { year: "2nd Year", oneTimeFee: 82000, tuitionFee: 27000 },
                { year: "3rd Year", oneTimeFee: 84000, tuitionFee: 28000 }
            ],
            "Civil Engineering (B.Tech/B.E., M.Tech)": [
                { year: "1st Year", oneTimeFee: 75000, tuitionFee: 24000 },
                { year: "2nd Year", oneTimeFee: 77000, tuitionFee: 25000 },
                { year: "3rd Year", oneTimeFee: 79000, tuitionFee: 26000 }
            ],
            ...
            "Chemical Engineering (B.Tech/B.E., M.Tech)": [
                ...
                { year: "2nd Year", oneTimeFee: 87000, tuitionFee: 28000 },
                { year: "3rd Year", oneTimeFee: 89000, tuitionFee: 29000 }
            ],
            "Aeronautical Engineering (B.Tech/B.E., M.Tech)": [
                { year: "1st Year", oneTimeFee: 90000, tuitionFee: 28000 },
                { year: "2nd Year", oneTimeFee: 92000, tuitionFee: 29000 },
                { year: "3rd Year", oneTimeFee: 94000, tuitionFee: 30000 }
            ],
    ...
    return (
        <form onSubmit={handleSubmit} style={formStyle}>
            ...
            <label htmlFor="course" style={labelStyle}>Select Course:</label>
            <select
                id="course"
                name="course"
